    ...
    <div class="flex-1 flex">
        ...
        <div class="w-2/5 border-r border-gray-100 overflow-y-scroll">
            <div class="flex flex-col">
                ...
                <!-- a chat list -->
                <div class="flex px-3 py-4 hover:bg-gray-50 border-b border-gray-100" v-for="message in 5" :key="message">
                    <img src="http://picsum.photos/200" class="w-10 h-10 rounded-full cursor-pointer mr-2" />
                    <div>
                        <div class="flex space-x-1">
                            <div class="font-bold">hyuna.com</div>
                            <div class="text-gray-500">@hyuna</div>
                            <div class="text-gray-500">12월 11일</div>
                        </div>
                        <div class="text-gray-500">메세지</div>
                    </div>
                </div>

                <div class="flex px-3 py-4 hover:bg-gray-50 border-b border-gray-100 bg-gray-200">
                    <img src="http://picsum.photos/200" class="w-10 h-10 rounded-full cursor-pointer mr-2" />
                    <div>
                        <div class="flex space-x-1">
                            <div class="font-bold">hyuna.com</div>
        ...
        <!-- chatting -->
        <div class="w-3/5 border-r border-gray-100 overflow-y-scroll">
            <div class="flex flex-col h-screen">
                ...
                <div class="flex px-3 h-14 items-center border-b border-gray-100">
                    ...
                    <div>
                        <div class="font-bold text-lg">hyuna.com</div>
                        <div class="text-sm text-gray-500">@hyuna</div>
                    </div>
                </div>
                ...
                <div class="flex flex-col justify-center items-center border-b border-gray-100 hover:bg-gray-100 py-6">
                    <div>
                        <span class="font-bold mr-1">hyuna.com</span>
                        <span class="text-gray-500">@hyuna</span>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <span class="text-gray-500">2022년 12월</span>
                    </div>
                </div>
                ...
                <div class="flex-1">
                    ...
                    <div class="text-right px-3 py-3">
                        ...
                        <div class="text-xs mt-2 text-gray-500">2022년 12월 11일 오후 14:10</div>
                    </div>
